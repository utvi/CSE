...
body_part1 = input("Give me a body part. ")

print("High school was filled with ups and downs but the hardest part was cutting off %s. " % plural_noun1)
print("The %s %s were always %s with my %s. " % (adj1, plural_noun2, verb_ing1, plural_noun3))
print("%s friends tried to warn me about people who %s. " % (adj2, verb2))
print("My favorite %s is the one that %s. " % (noun3, verb3))
print("Overall, I know I shouldn't %s but if I don't my %s hurts." % (verb4, body_part1))
